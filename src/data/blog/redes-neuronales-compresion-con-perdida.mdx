...
description: Entrenar una red neuronal es construir un compresor con pérdida. De Shannon a DeepMind, una exploración de la equivalencia entre predicción y compresión de información.
tags:
...
pubDatetime: 2026-06-25T00:00:00.000Z
draft: false
featured: true
slug: redes-neuronales-compresion-con-perdida
hideEditPost: true
...
<figure>
  <img
    src={`${SITE.base ?? ""}/assets/redes-neuronales-compresion.jpg`}
    alt="Redes neuronales como sistemas de compresión con pérdida"
  />

  <figcaption class="text-center">
    Redes neuronales como sistemas de compresión con pérdida
    &mdash; Photo: <a href="https://gustavosalvini.com.ar">Gustavo Adrián Salvini</a>
  </figcaption>
</figure>
...
En 1948, Claude Shannon publicó "A Mathematical Theory of Communication", un paper que fundó la [teoría de la información](https://es.wikipedia.org/wiki/Teor%C3%ADa_de_la_informaci%C3%B3n). Una de sus ideas más profundas fue que la **información** no es una cualidad subjetiva sino una cantidad medible, definida en términos de **incertidumbre** -una línea de pensamiento paralela a la de su contemporáneo [John von Neumann](https://es.wikipedia.org/wiki/John_von_Neumann) en Princeton.
...
Las redes neuronales se entrenan minimizando la [entropía cruzada](https://es.wikipedia.org/wiki/Entrop%C3%ADa_cruzada) (cross-entropy loss). Para un modelo que predice la probabilidad de cada token $x_i$ dado el contexto $x_{<i}$, la pérdida es:
