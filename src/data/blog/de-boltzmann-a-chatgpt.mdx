...
<figure>
  <img
    src={`${SITE.base ?? ""}/assets/post-de-boltzmann-a-chatgpt.jpg`}
    alt="De la física estadística a la IA"
  />
...
## 8. Explorador interactivo

<div style="margin-top: 1rem; max-width: 1024px; margin-inline: auto; padding-inline: clamp(0.25rem, 2vw, 1rem);">
  <div style="border: 1px solid var(--border); border-radius: 0.75rem; overflow: hidden; background: #1a1a2e;">
    <iframe
      src="/embeds/boltzmann-chatgpt.html"
      title="Boltzmann y ChatGPT: explorador interactivo"
      loading="lazy"
  ...
  <p style="margin-top: 0.5rem; font-size: 0.9rem;">
    ...
    <a href="/embeds/boltzmann-chatgpt.html" target="_blank" rel="noopener noreferrer">una pestaña nueva</a>.
  </p>
</div>
