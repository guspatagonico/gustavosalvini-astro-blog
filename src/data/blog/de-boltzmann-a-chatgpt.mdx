...
<div style="margin-top: 1rem; max-width: 1024px; margin-inline: auto; padding-inline: clamp(0.25rem, 2vw, 1rem);">
  <div style="border: 1px solid var(--border); border-radius: 0.75rem; overflow: hidden; background: #1a1a2e;">
    <iframe
      src="/embeds/boltzmann-chatgpt-slideshow.html"
      title="Boltzmann y ChatGPT: Introducción ilustrada"
      loading="lazy"
      style="display: block; width: 100%; aspect-ratio: 16 / 15; border: 0;"
    ></iframe>
  </div>
  <p style="margin-top: 0.5rem; font-size: 0.9rem;">
    Si no carga en esta vista, abrilo en
    <a href="/embeds/boltzmann-chatgpt-slideshow.html" target="_blank" rel="noopener noreferrer">una pestaña nueva</a>.
  </p>
</div>
